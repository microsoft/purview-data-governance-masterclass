...
Data Quality in Microsoft Purview is a feature that allows you to manage, and monitor data quality across multi-cloud data sources by leveraging the power of shortcuts in Micrsoft Fabric. 
...
This is a checklist of all the tasks that need to be done to get the data qualist process up and running. More in depth details of each task will be covered in the following sections.
...
Step 1:  Data assests has been scanned into the Purview Data Map [Review Lab 3: Managing Data Sources](./Lab-03%20-%20Managing%20Data%20Sources.md)
...
- [Duplicate rows](https://learn.microsoft.com/en-us/purview/concepts-data-quality-rules#duplicate-rows) This rule checks if there are rows with the same values accross the specified columns. 

- [Empty/blank fields](https://learn.microsoft.com/en-us/purview/concepts-data-quality-rules#emptyblank-fields) This ruile checks if there are any empty, blank or null value fields in the specified column.
...
**✨ Pro Tip:**
Carefully review rules suggested by the Copilot and ensure that they are relevant to the data asset, data quality scans are a copute intensive process and you don't want to run unnecessary scans.
...
This screen defaults to the Governance domain you clicked on but provides a drop down lfor you to easily switch to other domains you have access to. 
